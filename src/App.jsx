...
import { Sejarah, VisiMisi, TugasFungsi, StrukturOrganisasi } from './components/ProfilPages';
import { Penyuluhan, Perizinan, BantuanBibit, Pelatihan } from './components/LayananPages';
import { ProfilPPID, VisiMisiPPID, TugasFungsiPPID, InformasiPublik } from './components/PPIDPages';
import { FotoKegiatan, VideoDokumentasi } from './components/GaleriPages';
    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route path="/layanan" element={<Navigate to="/layanan/penyuluhan" replace />} />
                ...
                {/* Galeri Routes */}
                <Route path="/galeri/foto" element={<FotoKegiatan />} />
                <Route path="/galeri/video" element={<VideoDokumentasi />} />
                <Route path="/galeri" element={<Navigate to="/galeri/foto" replace />} />
