...
const PublikPortal = () => {
  ...
  const dokumen = [
    ...
    {
      title: "Rencana Strategis Dinas Pertanian 2021-2026",
      size: "4.1 MB",
      type: "PDF",
    },
    {
      title: "Daftar Isian Pelaksanaan Anggaran (DIPA) 2025",
      size: "1.8 MB",
      type: "PDF",
    },
    {
      title: "Profil Sektor Pertanian Sumatera Barat 2024",
      size: "5.2 MB",
      type: "PDF",
    },
  ];
        ...
        <div className="publik-grid">
          ...
          <div className="publik-column">
            <div className="column-header">
              ...
              <Link to="/kategori/download" className="view-all-btn">
