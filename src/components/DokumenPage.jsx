...
import { FileText, Download, ArrowLeft, ChevronRight, Search, FileCode, FileType, Filter, Share2, Info } from 'lucide-react';
            ...
            <div className="container-narrow">
                <header className="page-header-v2">
                    ...
                    <div className="header-content-v2">
                        ...
                        <p>Pusat unduhan berkas resmi, laporan kinerja, dan dokumen perencanaan Dinas Pertanian Provinsi Sumatera Barat.</p>
                    </div>
